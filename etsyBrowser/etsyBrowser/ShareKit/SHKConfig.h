...
#define SHKMyAppName			@"I Heart Etsy App"
#define SHKMyAppURL				@"http://gesturetheory.com"
 ...
 */
#define SHKTwitterConsumerKey		@"ntF82IKSKoqh4ZYZ1AQWkw"
#define SHKTwitterSecret			@"pezVHGxg2L2F4WEk5nxHg7r3hkGgwkMeyf3kqHnpnTk"
#define SHKTwitterCallbackUrl		@"http://gesturetheory.com" // You need to set this if using OAuth, see note above (xAuth users can skip it)
#define SHKTwitterUseXAuth			0 // To use xAuth, set to 1
#define SHKTwitterUsername			@"heartetsy" // Enter your app's twitter account if you'd like to ask the user to follow it when logging in. (Only for xAuth)

// Bit.ly (for shortening URLs on Twitter) - http://bit.ly/account/register - after signup: http://bit.ly/a/your_api_key
#define SHKBitLyLogin				@"heartetsy"
#define SHKBitLyKey					@"R_490f30429e8d77fc60dfbe322e4d1b16"
