var ETSY = {
    preloadImages: function() {
        var images = ["Favorites-no-items-2x.png", "ProductDetail-email-button-sprite-2x.png", "GeneralApp-active-title-bar-1x.png", "ProductDetail-facebook-button-sprite-1x.png", "GeneralApp-active-title-bar-2x.png", "ProductDetail-facebook-button-sprite-2x.png", "GeneralApp-background-1x.png", "ProductDetail-favorite-button-sprite-1x.png", "GeneralApp-background-2x.png", "ProductDetail-favorite-button-sprite-2x.png", "GeneralApp-white-title-bar-1x.png", "ProductDetail-favorite-stamp-1x.png", "GeneralApp-white-title-bar-2x.png", "ProductDetail-favorite-stamp-2x.png", "HeaderBar-background-texture-1x.png", "ProductDetail-info-tab-active-1x.png", "HeaderBar-background-texture-2x.png", "ProductDetail-info-tab-active-2x.png", "HeaderBar-bookmark-ribbon-off-1x.png", "ProductDetail-info-tab-link-1x.png", "HeaderBar-bookmark-ribbon-off-2x.png", "ProductDetail-info-tab-link-2x.png", "HeaderBar-bookmark-ribbon-on-1x.png", "ProductDetail-long-divider-1x.png", "HeaderBar-bookmark-ribbon-on-2x.png", "ProductDetail-long-divider-2x.png", "HeaderBar-left-menu-button-active-1x.png", "ProductDetail-slide-indicator-1x.png", "HeaderBar-left-menu-button-active-2x.png", "ProductDetail-slide-indicator-2x.png", "HeaderBar-left-menu-button-link-1x.png", "ProductDetail-staple-1x.png", "HeaderBar-left-menu-button-link-2x.png", "ProductDetail-staple-2x.png", "HeaderBar-logo-1x.png", "ProductDetail-title-bar-shadow-1x.png", "HeaderBar-logo-2x.png", "ProductDetail-title-bar-shadow-2x.png", "HeaderBar-logo-active-1x.png", "ProductDetail-twitter-button-sprite-1x.png", "HeaderBar-right-menu-button-active-1x.png", "ProductDetail-twitter-button-sprite-2x.png", "HeaderBar-right-menu-button-active-2x.png", "ProductDetail-vertical-divider-1x.png", "HeaderBar-right-menu-button-link-1x.png", "ProductDetail-vertical-divider-2x.png", "HeaderBar-right-menu-button-link-2x.png", "ProductListing-favorite-stamp-1x.png", "LeftNav-top-background-1x.png", "ProductListing-favorite-stamp-2x.png", "LeftNav-top-background-2x.png", "ProductListing-incart-icon-1x.png", "Product-container-2x.png", "ProductListing-incart-icon-2x.png", "Product-heart-stamp-1x.png", "Results-no-items-2x.png", "Product-sold-1x.png", "SplashScreen-background-1x.png", "Product-solid-2x.png", "SplashScreen-background-2x.png", "ProductDetail-background-1x.png", "SplashScreen-credit-1x.png.png", "ProductDetail-background-2x.png", "SplashScreen-credit-2x.png", "ProductDetail-cart-button-active-1x.png", "Treasuries-button-1x.png", "ProductDetail-cart-button-active-2x.png", "Treasuries-button-2x.png", "ProductDetail-cart-button-link-1x.png", "Treasuries-published-icon-1x.png", "Treasuries-published-icon-2x.png", "ProductDetail-cart-button-link-2x.png", "default_avatar_75px.png", "ProductDetail-close-tab-active-1x.png", "ProductDetail-close-tab-active-2x.png", "Product-container-1x.png", "ProductDetail-close-tab-link-1x.png", "search-button-1x.png", "ProductDetail-close-tab-link-2x.png", "search-button-2x.png", "ProductDetail-email-button-sprite-1x.png", "waiting-for-internet.png"]
